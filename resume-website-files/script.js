document.addEventListener('DOMContentLoaded', function() {
    ...
    certButtons.forEach(button => {
        button.addEventListener('click', function() {
            // In a real implementation, this would open a modal or link to the credential
            alert('In a real implementation, this would show the certification details or link to the credential.');
        });
    });
